...
B.Tech CSE @ VIT Bhopal (GPA: 8.69)| AI/ML Engineer | Data & Analytics

## About Me

* 💡 Strong foundation in Data Structures, DBMS, OS & AWS
...
* **IBM** – IBM Generative AI Engineering
* **NPTEL** – Introduction to Machine Learning
* **Google** – Computer Networking
* **Oracle** – Oracle Database@AWS Certified Architect Professional

---

## Current Focus
* Exploring Agile Methodologies & Agile Frameworks
* Deepening core Machine Learning concepts
